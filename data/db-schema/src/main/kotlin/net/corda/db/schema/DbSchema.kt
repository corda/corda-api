...
object DbSchema {
    ...
    const val CRYPTO_HSM_CATEGORY_CONFIG_MAP_TABLE = "crypto_hsm_category_config_map"
    const val CRYPTO_HSM_TENANT_ASSOCIATION_TABLE = "crypto_hsm_tenant_association"
}
