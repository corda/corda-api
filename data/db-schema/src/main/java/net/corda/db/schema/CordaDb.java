 ...
 * all database types will have such a row with a fixed connection name because they might be defining entities available
 * under multiple schemas named dynamically at run time. Likewise, a database type might have no entities defined under it,
