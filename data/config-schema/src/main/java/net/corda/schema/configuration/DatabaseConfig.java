...
public final class DatabaseConfig {
    ...
    public static final String DB_POOL_IDLE_TIMEOUT_SECS = "database.pool.idleTimeoutSecs";
    public static final String DB_POOL_MAX_LIFETIME_SECS = "database.pool.maxLifetimeSecs";
    public static final String DB_POOL_KEEPALIVE_TIME_SECS = "database.pool.keepaliveTimeSecs";
    public static final String DB_POOL_VALIDATION_TIMEOUT_SECS = "database.pool.validationTimeoutSecs";
}
