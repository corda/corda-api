...
public final class Schemas {
    ...
    public static final class Flow {
        ...
        public static final String FLOW_CRYPTO_STATE_TOPIC = getStateAndEventStateTopic(FLOW_CRYPTO_TOPIC);
        public static final String FLOW_CRYPTO_DLQ_TOPIC = getDLQTopic(FLOW_CRYPTO_TOPIC);
        public static final String FLOW_DB_TOPIC = "flow.db";
        public static final String FLOW_DB_STATE_TOPIC = getStateAndEventStateTopic(FLOW_DB_TOPIC);
        public static final String FLOW_DB_DLQ_TOPIC = getDLQTopic(FLOW_DB_TOPIC);
        public static final String FLOW_LEDGER_TOPIC = "flow.ledger";
        public static final String FLOW_LEDGER_STATE_TOPIC = getStateAndEventStateTopic(FLOW_LEDGER_TOPIC);
        public static final String FLOW_LEDGER_DLQ_TOPIC = getDLQTopic(FLOW_LEDGER_TOPIC);
        public static final String FLOW_UNIQUENESS_TOPIC = "flow.uniqueness";
        public static final String FLOW_UNIQUENESS_STATE_TOPIC = getStateAndEventStateTopic(FLOW_UNIQUENESS_TOPIC);
        public static final String FLOW_UNIQUENESS_DLQ_TOPIC = getDLQTopic(FLOW_UNIQUENESS_TOPIC);
        ...
        public static final String FLOW_MAPPER_SESSION_EVENT_TOPIC = "flow.mapper.session.event";
        public static final String FLOW_MAPPER_SESSION_EVENT_STATE_TOPIC = getStateAndEventStateTopic(FLOW_MAPPER_SESSION_EVENT_TOPIC);
        public static final String FLOW_MAPPER_SESSION_EVENT_DLQ_TOPIC = getDLQTopic(FLOW_MAPPER_SESSION_EVENT_TOPIC);
