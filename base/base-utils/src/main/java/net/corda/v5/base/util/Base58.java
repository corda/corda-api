...
public final class Base58 {
     ...
     */
    @NotNull
    public static String encode(@NotNull byte[] input) {
        if (input.length == 0) {
            return "";
        }
        // Count leading zeros.
     ...
     */
    @NotNull
    public static byte[] decode(@NotNull String input) throws IllegalArgumentException {
        if (input.isEmpty()) {
            return new byte[0];
        }
    ...
    @NotNull
    public static BigInteger decodeToBigInteger(@NotNull String input) throws IllegalArgumentException {
     ...
     */
    private static byte divmod(@NotNull byte[] number, int firstDigit, int base, int divisor) {
