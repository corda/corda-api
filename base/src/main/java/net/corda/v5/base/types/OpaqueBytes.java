...
public class OpaqueBytes extends ByteSequence {
     ...
     * to prevent tampering with entities such as {@code net.corda.v5.crypto.SecureHash} and {@code net.corda.v5.ledger.common.transactions.PrivacySaltImpl}, as well as
     * preserve the integrity of our hash constants {@code net.corda.v5.crypto.DigestServiceUtils#getZeroHash} and {@code net.corda.v5.crypto.DigestServiceUtils#getAllOnesHash}.
     *
