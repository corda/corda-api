...
import net.corda.v5.ledger.obsolete.notary.NotaryError;
import net.corda.v5.ledger.obsolete.notary.NotaryException;
import net.corda.v5.ledger.obsolete.notary.StateConsumptionDetails;
