...
import net.corda.v5.ledger.obsolete.contracts.LinearPointer;
import net.corda.v5.ledger.obsolete.contracts.LinearState;
import net.corda.v5.ledger.obsolete.contracts.StateAndRef;
import net.corda.v5.ledger.obsolete.contracts.StateRef;
import net.corda.v5.ledger.obsolete.contracts.StaticPointer;
