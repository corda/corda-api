...
import net.corda.v5.ledger.obsolete.contracts.ClassInfo;
import net.corda.v5.ledger.obsolete.contracts.Contract;
import net.corda.v5.ledger.obsolete.contracts.ContractState;
import net.corda.v5.ledger.obsolete.contracts.PackageIdWithDependencies;
import net.corda.v5.ledger.obsolete.contracts.StateAndRef;
import net.corda.v5.ledger.obsolete.contracts.StateInfo;
...
import net.corda.v5.ledger.obsolete.identity.AbstractParty;
import net.corda.v5.ledger.obsolete.identity.Party;
import net.corda.v5.ledger.obsolete.transactions.BaseTransaction;
