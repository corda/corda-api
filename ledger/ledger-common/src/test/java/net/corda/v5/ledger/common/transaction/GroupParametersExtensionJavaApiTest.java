...
import net.corda.v5.ledger.common.GroupParametersExtension;
...
public class GroupParametersExtensionJavaApiTest {
    ...
    public void getNotaryServiceParty() {
        ...
        var result = GroupParametersExtension.getNotaries(groupParameters);
