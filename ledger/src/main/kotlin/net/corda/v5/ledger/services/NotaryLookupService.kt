...
interface NotaryLookupService : CordaFlowInjectable, CordaServiceInjectable {
     ...
     * [Party.toString] returns comma separated values of [CordaX500Name].
     *
     ...
     *
     * @param notaryServiceName The [CordaX500Name] of the notary service
     * 		to retrieve.
     *
     * @return The [NotaryInfo] that matches the input [notaryServiceName],
     *      or null if no such notary exists.
     */
    ...
    /**
     * Returns true if and only if the given [Party] is a notary, which is
     * defined by the network parameters.
     *
     * @param party The [Party] to check.
     *
     * @return true if the input [party] is a notary, or false if it is not
