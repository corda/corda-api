...
class SignaturesMissingException(val missing: Set<PublicKey>, val descriptions: List<String>, val id: SecureHash): SignatureException(missingSignatureMsg(missing, descriptions, id)), CordaThrowable by CordaRuntimeException(missingSignatureMsg(missing, descriptions, id)) {
