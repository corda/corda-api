...
/**
 * The base class for notary exceptions that were fatal and might return with a different result when retried. These
 * type of exceptions will not invalidate the transaction immediately.
 */
@CordaSerializable
