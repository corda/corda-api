...
/**
 * An annotation used on [PluggableNotaryClientFlowProvider] implementations to define the
 * type of the notary plugin it instantiates. See [PluggableNotaryClientFlowProvider] for
 * more details.
 *
