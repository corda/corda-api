...
public interface MemberLookup {
    ...
    /**
     * @return the {@link MemberInfo} for the calling flow.
     */
    @Suspendable
    @NotNull
    MemberInfo myInfo();
     ...
     *
     * @return An instance of {@link MemberInfo} for the given {@link MemberX500Name} name or {@code null} if no member found.
     */
    @Suspendable
    @Nullable
     ...
     *
     * @return An instance of {@link MemberInfo} for the given {@link PublicKey} name or {@code null} if no member found.
     */
    @Suspendable
    @Nullable
