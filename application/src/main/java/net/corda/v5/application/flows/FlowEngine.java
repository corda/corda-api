...
public interface FlowEngine {
    /**
     * @return the flow id that identifies this flow.
     *
     ...
     * <ul>
     * <li>The result executing of {@link SubFlow#call}.</li>
     * <li>An exception thrown by {@link SubFlow#call}.</li>
     * </ul>
     * Any open {@link FlowSession}s created within a {@link SubFlow} annotated with {@link InitiatingFlow} are sent:
     * <ul>
     * <li>Session close messages after successfully completing the {@link SubFlow}.</li>
     * <li>Session error messages when an exception is thrown from the {@link SubFlow}.</li>
     * </ul>
