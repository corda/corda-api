package net.corda.v5.application.flows.interop.binding.api

import net.corda.v5.application.flows.interop.binding.api.InteropAction.ClientAction
import net.corda.v5.application.flows.interop.binding.api.InteropAction.ServerResponse
