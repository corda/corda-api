...
public final class KeySchemeCodes {
     ...
     */
    @NotNull public static final String RSA_CODE_NAME = "CORDA.RSA";
     ...
     * The key scheme can be used for signing and key derivation such as ECDH.
     */
    @NotNull public static final String ECDSA_SECP256R1_CODE_NAME = "CORDA.ECDSA.SECP256R1";
    
    /**
     * EdDSA with 25519PH curve key scheme code name.
     * The key scheme can be used for signing only.
     */
    @NotNull public static final String EDDSA_ED25519_CODE_NAME = "CORDA.EDDSA.ED25519";
